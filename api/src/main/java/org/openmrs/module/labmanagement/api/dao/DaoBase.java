...
import org.openmrs.module.labmanagement.api.IPagingInfo;
...
public class DaoBase {
	...
	protected org.hibernate.Session getCurrentHibernateSession() {
		try {
			...
			try {
				...
				Method method = hibernateSessionFactory.getClass().getMethod("getCurrentSession", (Class<?>[]) null);
				return (org.hibernate.Session) method.invoke(hibernateSessionFactory, (Object[]) null);
			}
			catch (Exception e) {
	...
	protected org.hibernate.StatelessSession getStatelessHibernateSession() {
		try {
			...
			try {
				Object hibernateSessionFactory = sessionFactory.getHibernateSessionFactory();
				Method method = hibernateSessionFactory.getClass().getMethod("openStatelessSession", (Class<?>[]) null);
				return (org.hibernate.StatelessSession) method.invoke(hibernateSessionFactory, (Object[]) null);
			}
			catch (Exception e) {
