...
public class BatchJobSearchFilter {
	...
	private List<BatchJobType> batchJobTypes;
	...
	public List<BatchJobType> getBatchJobTypes() {
		return batchJobTypes;
	}

	public void setBatchJobTypes(List<BatchJobType> batchJobTypes) {
		this.batchJobTypes = batchJobTypes;
	}
