...
public class BatchJobDTO {
	...
	private HashMap<String, ReportParameterValue<?>> reportParameters;
	...
	public void setParametersMap(Map<String, ?> parametersMap) {
		this.parametersMap = parametersMap;
	}

	public HashMap<String, ReportParameterValue<?>> getReportParameters() {
		return reportParameters;
	}

	public void setReportParameters(HashMap<String, ReportParameterValue<?>> reportParameters) {
